...
class AppColors {
  ...
  static const Color blazeOrangeAlt = Color(0xFFFF7201); // Duplicate renamed
  static const Color bleachedCedar = Color(0xFF281F33);
  static const Color saltBox = Color(0xFF6C6673);
  static const Color shipGray = Color(0xFF4B4454);
  static const Color neonCarrot = Color(0xFFFF9134);
  static const Color blackCurrant = Color(0xFF342C3E);
  static const Color topaz = Color(0xFF84808A);
