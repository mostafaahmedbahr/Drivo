...
class CarDetailsModel {
  ...
  String? color;
  String? plateNumber;
  dynamic currentKilometerReading;
  dynamic allowedKilometers;
  dynamic extraKilometerPrice;
  dynamic lateHourFee;
  dynamic dailyRenterPrice;
  dynamic weeklyRenterPrice;
  dynamic monthlyRenterPrice;
  dynamic imageUrl;
  dynamic rentHourCost;
  dynamic fullFuelCost;
  dynamic oilChangeKmDistance;
  String? oilChangeDate;
  dynamic enduranceAmount;
  dynamic allowedKmPerDay;
  dynamic allowedLateHours;
  dynamic allowedKmPerHour;
  dynamic plateType;
  dynamic kilometersAtExit;
  dynamic extraKmCost;
  dynamic offer;
  bool? hasGps;
  String? letter1;
